...
const squareOne = document.getElementById("grid-square1");
const squareTwo = document.getElementById("grid-square2");
const squareThree = document.getElementById("grid-square3");
const squareFour = document.getElementById("grid-square4");
const squareFive = document.getElementById("grid-square5");
const squareSix = document.getElementById("grid-square6");
const squareSeven = document.getElementById("grid-square7");
const squareEight = document.getElementById("grid-square8");
const squareNine = document.getElementById("grid-square9");
const allSquares = document.querySelectorAll(".grid-square");

const playerOneScore = document.getElementById("player-score1");
const playerTwoScore = document.getElementById("player-score2");
...
function startGame() {
  ...
  form.addEventListener("submit", (event) => {
    ...
    document.getElementById("info-player1").innerHTML =
      players.playerOne.name;
    document.getElementById("info-player2").innerHTML =
    ...
    startGameBtn.innerHTML = "Game Reset";
    addSquareClick();
    restartGame();
  });
}
